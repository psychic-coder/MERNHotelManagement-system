...
export const newUser = TryCatch(async (req, res, next) => {
    ...
    const user = await pool.query( 'SELECT "username", "email", "phone", "address" FROM "People" WHERE "username" = $1 OR "email" = $2', [username, email]);
    if (user.rowCount != 0) {
    ...
    const query = `
      INSERT INTO "People" (username, password, email, phone, address)
      VALUES ($1, $2, $3, $4, $5);
    `;
